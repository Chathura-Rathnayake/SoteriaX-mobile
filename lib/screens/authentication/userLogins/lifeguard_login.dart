...
class LifeguardLogin extends StatefulWidget {
  const LifeguardLogin({Key? key}) : super(key: key);

  @override
  _LifeguardLoginState createState() => _LifeguardLoginState();
}

class _LifeguardLoginState extends State<LifeguardLogin> {
                        ...
                        children: [
                          ...
                          MaterialButton(
                            onPressed: () async{
                              if(_formkey.currentState!.validate()){
                                ...
                                dynamic result=await _auth.signInWithEmailAndPassword(email, password, "l");
                                if(result==null){
                                  setState(() {
                          ...
                          if(_auth.errorMessageL!="")
                            Container(
                              ...
                              child: ListTile(
                                title: Text(_auth.errorMessageL, style: TextStyle(color: Colors.red[900], fontSize: 14), ),
