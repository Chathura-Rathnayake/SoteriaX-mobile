                                ...
                                children: [
                                    ...
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: ListTile(
                                          leading: Image(
                                            image: AssetImage(
                                                "assets/icons/mobile_engagement.png"),
                                          ),
                                          title: Text(
                                              liveOpSnapshot.data!.docs.isEmpty
                                                  ? "No Current live operations"
                                                  : liveOpSnapshot.data!.docs[0]
                                                          .get('engaged')
                                                      ? "Engaged"
                                                      : "Not Engaged"),
                                  ...
                                  if (liveOpSnapshot.data!.docs.isEmpty)
                                    MaterialButton(
                                      onPressed: () async {
                                        String? opId =
                                            await _opDB.addLiveOperation();
                                        if (opId == null) {
                                          setState(() {
                                            feedbackMessage =
                                                "Something went wrong Couldn't create operation..";
                                          });
                                        } else {
                                  ...
                                  if (liveOpSnapshot.data!.docs
                                      .isNotEmpty) //existing live operations
                                    liveOpSnapshot.data!.docs[0]
                                                .get('engaged') ==
                                            false
                                        ? //not engaged
