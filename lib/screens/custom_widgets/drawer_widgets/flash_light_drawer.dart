          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text("Flash Light", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16), ),
              ),
              SizedBox(height: 20,),
              Padding(
              ...
              Row(
                ...
                children: [
                  IconButton(
                      ...
                      iconSize: 60,
                      icon: Icon(Icons.flashlight_on, size: 60,)
                  ),
                  SizedBox(width: 40,),
                  IconButton(
                      onPressed: (){
                      ...
                      iconSize: 60,
                      icon: Icon(Icons.flashlight_off, size: 60,)
                  ),
                ],
              ),
              Padding(
